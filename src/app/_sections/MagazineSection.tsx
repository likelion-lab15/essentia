...
export default function MagazineSection() {
  return (
    <section className="flex h-screen w-screen items-center justify-center bg-primary">
      <div className="h-[800px] w-[1440px] bg-primary px-[150px] py-[80px]">
        ...
        <p className="text-18 font-medium text-white">
          ONYX MAGAZINE은 일상에서 시작하여 감각적인 향수로 새로운 삶을
          탐험하며, 향기의 매력으로 일상을 더욱 풍요롭게 만듭니다.
        </p>
        <p className="text-18 font-medium text-white">
          ONYX와 함께라면, 당신의 향기로 가득한 평범한 순간마저도 특별한 기억이
          될 것입니다.
        </p>
          ...
          <Link href="/" className="relative h-[450px] w-[370px]">
            ...
            <div className="absolute left-[20px] top-[295px]">
              ...
              <p className="w-[320px] text-14 font-medium text-secondary">
                조향사가 소개하는 그들만의 감각과 예술적 소양이 어우러진
                향수들을 만나보세요. 향수의 제작 과정, 영감, 그리고 특별한
                향수들의 이야기를 담아내어 향의 예술에 대한 새로운 시선을
                소개합니다.
              </p>
            </div>
          </Link>
